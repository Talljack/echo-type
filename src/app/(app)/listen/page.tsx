...
export default function ListenPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold font-[var(--font-poppins)] text-indigo-900">Listen</h1>
        <p className="text-indigo-600 mt-1">Listen to English content with text-to-speech</p>
      </div>
