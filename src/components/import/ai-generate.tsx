...
export function AIGenerate() {
  ...
  const handleSave = async () => {
    ...
    const item: ContentItem = {
      ...
      type: result.type, tags: [...new Set([...normalizeTags(tags), topic.trim().toLowerCase()])].filter(Boolean), source: 'ai-generated', difficulty,
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <Input value={tags} onChange={(e) => setTags(e.target.value)} placeholder="e.g. ai-generated, grammar" className="bg-white border-slate-200" />
