  ...
  return (
    <Card className="bg-white border-slate-100 shadow-sm">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium text-indigo-600">WPM Progression</CardTitle>
      </CardHeader>
      <CardContent>
        {filtered.length === 0 ? (
          <p className="text-sm text-indigo-400 py-8 text-center">No WPM data yet</p>
        ) : (
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={data}>
              ...
              <Tooltip
                ...
                formatter={((value: number) => [`${value} WPM`, 'Speed']) as never}
              />
