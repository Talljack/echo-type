...
const translations: Record<string, Record<SupportedLang, string>> = {
  ...
  'common.pause': { en: 'Pause', zh: '暂停', ja: '一時停止', ko: '일시 중지' },
  ...
  'common.tryAgain': { en: 'Try Again', zh: '再试一次', ja: 'もう一度', ko: '다시 시도' },

  // Practice
  'practice.recommendationsTitle': {
    en: 'AI Recommendations',
    zh: 'AI 推荐',
    ja: 'AIおすすめ',
    ko: 'AI 추천',
  },
  'practice.recommendationsEmpty': {
    en: 'No recommendations yet. Try again after loading more context.',
    zh: '暂无推荐，可稍后重试。',
    ja: 'まだおすすめがありません。少し待ってから再試行してください。',
    ko: '아직 추천이 없습니다. 잠시 후 다시 시도하세요.',
  },
  'practice.recommendationsGenerating': {
    en: 'Generating recommendations...',
    zh: '正在生成推荐...',
    ja: 'おすすめを生成中...',
    ko: '추천 생성 중...',
  },
  'practice.goToSettings': {
    en: 'Configure AI provider in Settings',
    zh: '请先在设置中配置 AI Provider',
    ja: '設定でAIプロバイダーを構成してください',
    ko: '설정에서 AI 공급자를 먼저 구성하세요',
  },

  // Listen
  'listen.title': { en: 'Listen', zh: '听力', ja: 'リスニング', ko: '듣기' },
  'listen.subtitle': {
    en: 'Choose a passage, press play, and train your ear with aligned text and translation.',
    zh: '选择内容，开始播放，并结合对齐文本和翻译进行听力训练。',
    ja: '教材を選んで再生し、対訳付きテキストでリスニングを鍛えます。',
    ko: '콘텐츠를 골라 재생하고, 정렬된 텍스트와 번역으로 듣기 연습을 합니다.',
  },
  'listen.continueLastSession': {
    en: 'Continue where you left off',
    zh: '继续上次练习',
    ja: '前回の続きから',
    ko: '이어서 학습하기',
  },
  'listen.recentSessions': { en: 'Recent sessions', zh: '最近练习', ja: '最近のセッション', ko: '최근 세션' },
  'listen.practiceLibrary': { en: 'Practice library', zh: '练习内容库', ja: '練習ライブラリ', ko: '연습 라이브러리' },
  'listen.searchPlaceholder': {
    en: 'Search title, text, or tags',
    zh: '搜索标题、正文或标签',
    ja: 'タイトル、本文、タグを検索',
    ko: '제목, 본문 또는 태그 검색',
  },
  ...
  'listen.emptyDescription': {
    en: 'Try another filter or import new material from the library.',
    zh: '试试其他筛选条件，或先去资料库导入新内容。',
    ja: '別の条件で探すか、ライブラリから新しい教材を追加してください。',
    ko: '다른 필터를 사용하거나 라이브러리에서 새 콘텐츠를 가져오세요.',
  },
  'listen.allContent': { en: 'All content', zh: '全部内容', ja: 'すべて', ko: '전체 콘텐츠' },
  'listen.wordbooks': { en: 'Wordbooks', zh: '词书', ja: '単語帳', ko: '단어장' },
  'listen.referenceText': { en: 'Reference text', zh: '参考文本', ja: '参照テキスト', ko: '참고 텍스트' },
  'listen.referenceHint': {
    en: 'Tap any word to replay it while the current sentence stays in sync.',
    zh: '点任意单词可单独重听，当前句子会保持同步高亮。',
    ja: '単語をタップするとその語だけ再生でき、現在の文が同期してハイライトされます。',
    ko: '단어를 탭하면 해당 단어를 다시 들을 수 있고, 현재 문장이 동기화되어 강조됩니다.',
  },
  'listen.estimatedDuration': { en: 'Estimated time', zh: '预计时长', ja: '予想時間', ko: '예상 시간' },
  'listen.words': { en: 'Words', zh: '词数', ja: '語数', ko: '단어 수' },
  'listen.voice': { en: 'Voice', zh: '声音', ja: '音声', ko: '음성' },
  'listen.continueLearning': { en: 'Continue learning', zh: '继续学习', ja: '学習を続ける', ko: '계속 학습하기' },
  'listen.continueRead': {
    en: 'Read this text aloud',
    zh: '朗读这篇内容',
    ja: 'この文章を音読する',
    ko: '이 텍스트를 소리 내어 읽기',
  },
  'listen.continueReadDesc': {
    en: 'Switch to shadow reading and practice pronunciation on the same passage.',
    zh: '切到朗读模式，用同一篇内容练发音。',
    ja: '同じ文章でシャドーイングと発音練習に切り替えます。',
    ko: '같은 지문으로 쉐도잉과 발음 연습을 이어갑니다.',
  },
  'listen.continueSpeak': {
    en: 'Talk about this topic',
    zh: '围绕这个主题开口说',
    ja: 'このテーマで話してみる',
    ko: '이 주제로 말해 보기',
  },
  'listen.continueSpeakDesc': {
    en: 'Open a free conversation seeded with this lesson topic.',
    zh: '用这篇内容的话题开启一段自由对话。',
    ja: 'この教材のテーマをもとにフリー会話を始めます。',
    ko: '이 수업 주제로 자유 대화를 시작합니다.',
  },
  'listen.continueAnotherListen': {
    en: 'Keep listening',
    zh: '继续听下一篇',
    ja: '次の教材を聞く',
    ko: '다음 듣기 이어서',
  },
  'listen.continueAnotherListenDesc': {
    en: 'Jump back to the listen library and pick another passage.',
    zh: '回到听力内容库，继续下一篇材料。',
  ...
  'read.referenceHint': {
    en: 'Keep the original text visible. Translation appears below it when enabled.',
    zh: '原文始终保持可见，开启翻译后会显示在下方。',
    ja: '原文は常に表示され、翻訳は有効時に下に表示されます。',
    ko: '원문은 항상 보이고, 번역은 켜면 아래에 표시됩니다.',
  },
  ...
  'read.results': { en: 'Results', zh: '结果', ja: '結果', ko: '결과' },
  'read.processingSpeech': {
  ...
  'write.referenceText': { en: 'Reference Text', zh: '参考文本', ja: '参照テキスト', ko: '참고 텍스트' },
  'write.referenceHint': {
    en: 'Use the reference text and type the passage exactly as shown.',
    zh: '参考原文，按显示内容逐字输入。',
    ja: '参照テキストを見ながら、そのまま入力してください。',
    ko: '참고 텍스트를 보고 그대로 입력하세요.',
  },
  ...
  'write.resume': { en: 'Resume', zh: '继续', ja: '再開', ko: '계속하기' },
  'write.resumeHint': {
    en: 'Tap resume to continue typing.',
    zh: '点击继续恢复输入。',
    ja: '再開を押して入力を続けます。',
    ko: '계속하기를 눌러 타이핑을 이어가세요.',
  },
  'write.startHint': {
    en: 'Tap the typing area and start with the first character.',
    zh: '点击输入区域，从第一个字符开始。',
    ja: '入力エリアをタップして最初の文字から始めます。',
    ko: '입력 영역을 탭하고 첫 글자부터 시작하세요.',
  },
  ...
  'write.listen': { en: 'Listen', zh: '听一遍', ja: '聞く', ko: '듣기' },
  'write.reset': { en: 'Reset', zh: '重置', ja: 'リセット', ko: '재설정' },
  'write.showTranslation': { en: 'Show Translation', zh: '显示翻译', ja: '翻訳を表示', ko: '번역 보기' },
  'write.hideTranslation': { en: 'Hide Translation', zh: '隐藏翻译', ja: '翻訳を隠す', ko: '번역 숨기기' },
  'write.reviewErrors': { en: 'Review Errors', zh: '复习错词', ja: 'ミスを復習', ko: '오답 복습' },
  'write.fullTextAgain': { en: 'Full Text Again', zh: '回到全文', ja: '全文に戻る', ko: '전체 텍스트 다시' },
  'write.errorWords': { en: 'Error Words', zh: '错误单词', ja: 'ミスした単語', ko: '오답 단어' },
  'write.backToLibrary': { en: 'Back to Library', zh: '返回列表', ja: 'ライブラリへ戻る', ko: '라이브러리로 돌아가기' },
  'write.wordsProgress': {
    en: '{done} / {total} words',
    zh: '{done} / {total} 词',
    ja: '{done} / {total} 語',
  ...
  'speak.subtitle': {
    en: 'Start a free conversation or jump into a guided scenario with AI feedback.',
    zh: '开始自由对话，或进入带有 AI 反馈的场景练习。',
    ja: 'フリートークを始めるか、AIフィードバック付きのシナリオ練習に進みます。',
    ko: '자유 대화를 시작하거나 AI 피드백이 있는 시나리오 연습으로 들어가세요.',
  },
  ...
  'speak.speechNotAvailable': {
    en: 'Speech recognition is not available in Expo Go on this device.',
    zh: '当前环境的 Expo Go 不支持语音识别。',
    ja: 'この環境のExpo Goでは音声認識を利用できません。',
    ko: '이 환경의 Expo Go에서는 음성 인식을 사용할 수 없습니다.',
  },
  'speak.freeShort': { en: 'Free', zh: '自由', ja: 'フリー', ko: '자유' },
  'speak.playVoice': { en: 'Play voice', zh: '播放语音', ja: '音声を再生', ko: '음성 재생' },
  'speak.stopVoice': { en: 'Stop voice', zh: '停止语音', ja: '音声を停止', ko: '음성 중지' },
